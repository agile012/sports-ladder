                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {data.slice(0, 4).map((r, i) => (
                        <div key={i} className="flex items-center justify-between p-4 bg-background/40 backdrop-blur border rounded-xl hover:border-purple-500/30 transition-colors">
                            {/* P1 */}
                            <Link href={`/player/${r.p1}`} className="flex items-center gap-3 group/p1">
                                ...
                                <div className="text-right">
                                    <p className="font-bold text-xs group-hover/p1:text-primary transition-colors">{r.p1_name || 'Unknown'}</p>
                            ...
                            {/* P2 */}
                            <Link href={`/player/${r.p2}`} className="flex items-center gap-3 flex-row-reverse text-right group/p2">
                                ...
                                <div className="text-left">
                                    <p className="font-bold text-xs group-hover/p2:text-primary transition-colors">{r.p2_name || 'Unknown'}</p>
